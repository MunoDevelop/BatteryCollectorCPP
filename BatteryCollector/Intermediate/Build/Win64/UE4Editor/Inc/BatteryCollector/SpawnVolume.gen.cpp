...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASpawnVolume()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_WhereToSpawn = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("WhereToSpawn"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WhereToSpawn, ASpawnVolume), 0x00400000000a0009, Z_Construct_UClass_UBoxComponent_NoRegister());
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ASpawnVolume_GetRandomPointInVolume(), "GetRandomPointInVolume"); // 3434494014
				...
				MetaData->SetValue(NewProp_WhereToSpawn, TEXT("AllowPrivateAcess"), TEXT("true"));
	...
	IMPLEMENT_CLASS(ASpawnVolume, 228763560);
